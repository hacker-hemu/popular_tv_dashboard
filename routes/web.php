...
Route::prefix('admin')->middleware(['auth', 'isAdmin'])->group(function () {
    ...
    //     index ad route
    Route::get('/ad', [App\Http\Controllers\Admin\AdController::class, 'index']);

    //     create ad route
    Route::get('/add-ad', [App\Http\Controllers\Admin\AdController::class, 'create']);

    //     store  ad route
    Route::post('/add-ad', [App\Http\Controllers\Admin\AdController::class, 'store']);

    //     edit ad route
    Route::get('/edit-ad/{ad_id}', [App\Http\Controllers\Admin\AdController::class, 'edit']);

    //     update ad route
    Route::put('/update-ad/{user_id}', [App\Http\Controllers\Admin\AdController::class, 'update']);
